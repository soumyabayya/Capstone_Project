...
def find_matching_symptoms(user_input, threshold=0.8):
    ...
    while i < len(input_symptoms):
        # Try matching 3-word phrases first
        ...
        for dataset_symptom in DATASET_SYMPTOMS:
            ...
            score = calculate_similarity(input_symptoms[i], dataset_symptom)
...
def predict_disease_from_symptoms(matched_symptoms):
    ...
    for disease, disease_symptoms in DISEASE_SYMPTOMS.items():
        ...
        combined_score = (match_percentage * 0.3) + (user_match_percentage * 0.7)
        ...
        try:
            ...
            if not matched_symptoms:
                ...
                for symptom in user_symptoms:
                    symptom_matches = find_matching_symptoms(symptom, threshold=0.7)
            ...
            if not predicted_disease:
                ...
                common_symptoms = {'fever', 'headache', 'cough', 'cold', 'flu'}
